...
class Productos(Lista):
    ...
    def to_dict(self):
        ...
        if type(self) == list:
            ...
            diccionario = {"codigo": self.codigo, "nombre": self.nombre, "descripcion": self.descripcion, "precio": self.precio}
    ...
    def from_json(self):
        ...
        for prod in productos_json:
            cli = Productos(prod["codigo"], prod["nombre"], prod["descripcion"], prod["precio"])
